(function ($) {
    ...
    $(document).ready(function ()
    {
        ...
        // Full height fix
        function resizeVideoJSHeight() {
            $('.container-fullheight').height(window.innerHeight);
        }
...
// ============================================================================
    ...
    function animate_init()
    {
        ...
        function animate_on_scroll()
        {
            ...
            if ($elms.length == 0)
                $(window).unbind('scroll.vmanimate');
        }
...
// ============================================================================
    ...
    function init_gallery_w_preview()
    {
        ...
        function refresh_items_order_data() {
            $gl_items = $gallery.find('.gl-item:visible').each(function () {
        ...
        function remove_preview()
        {
            ...
            if ($preview.length)
                $gallery.isotope('remove', $preview).isotope('layout');
        }
